...
컨벤션을 미리 정해두고 초기 세팅을 한 후 각자 맡은 부분에 대해 진행하고 논의해 프로젝트에 대한 어려움은 없었던 것 같습니다. 
초반에 머지할 때 충돌이 자주 발생해 어려움이 있었지만 멘토님께 여쭤보고 같이 소통하면서 해결해나가서 중후반부에는 깃에 대한 어려움이 없었던 것 같습니다
코드리뷰를 남겨드렸을 때 다들 잘 수용해서 수정해주셔서 감사했고 부족한 팀장이었지만 같이 모자람 없이 완성시켜서 너무 좋았습니다.
첫 팀 프로젝트를 이런 좋은 경험으로 마칠 수 있어서 다음에도 잘 마칠 수 있을 거 같습니다!
